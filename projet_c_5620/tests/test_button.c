...
int ei_main(int argc, char** argv)
{
  ...
  color -> alpha = 0xAB;
	...
	ei_draw_button(main_window, rectangle, 40, *color2, *color3, text2, EI_TRUE, ei_default_font, NULL);
	ei_size_t size2 = {200, 100};
	ei_point_t top_left2 = {300, 300};
	ei_rect_t rectangle2 = {top_left2, size2};
	ei_draw_button(main_window, rectangle2, 40, *color2, *color3, text2, EI_FALSE, ei_default_font, NULL);
