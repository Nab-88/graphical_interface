/**
 *  @file	ei_draw_widgets.h
 *  @brief	Graphical primitives to draw widgets
 *
 */
...
/**
* \brief	This function draws a toplevel 
*
...
* @param  color2 the color of the banner of the toplevel
